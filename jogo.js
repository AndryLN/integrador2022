...
function clicarClero() {
    alert("Você escolheu o Clero")
    document.getElementById("clero").innerHTML = "Clero"
 }
function clicarBurgues() {
    alert("Você escolheu a Burguesia")
    document.getElementById("burguesia").innerHTML = "Burguesia"
 }
...
function clicarProleta() {
    alert("Você escolheu o Proletáriado")
    document.getElementById("proleta").innerHTML = "Proletáriado"
 }
